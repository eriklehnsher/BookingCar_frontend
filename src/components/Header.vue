		...
		<div class="d-flex justify-content-between align-items-center">
			...
			<div class="header__portfolio d-flex align-items-center" v-else>
				...
				<b-dropdown id="dropdown-user" text="" class=" header__portfolio--dropdown m-md-2">
					...
					<b-dropdown-item>
						<router-link to="/portfolio"  tag="a" class="portfolio--dropdow__router"> Quản Trị Viên </router-link>
					</b-dropdown-item>

					<b-dropdown-item>
						<router-link to="/user/:user_id"  tag="a" class="portfolio--dropdow__router"> Tài Khoản </router-link>
					</b-dropdown-item>
