<template>
  <div class="register">
    ...
    <b-modal
      ...
      size="lg"
    >
      <h1 class="register__form--title text-center">Đăng ký</h1>
      <!-- Form -->
      <div class="register__form mt-4">
        ...
        <div class="d-flex flex-column justify-content-start mb-4">
          <span class="register__form--title-input"> Tên hiển thị </span>
          <b-input
            type="text"
            class="register-form__input"
        ...
        <div class="d-flex flex-column justify-content-start">
          <span class="register__form--title-input"> Mật khẩu </span>
          <b-input
            type="password"
            class="register-form__input"
        ...
        <div class="d-flex flex-column justify-content-start mb-4">
          <span class="register__form--title-input">Nhập lại Mật Khẩu</span>
          <b-input
            type="password"
            class="register-form__input"
      ...
      <div class="text-center">
        <b-button class="register__button" variant="success" @click="submitRegister()"
          >ĐĂNG KÝ</b-button
        >
      </div>
    </b-modal>
