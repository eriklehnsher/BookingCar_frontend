  ...
  <div>
    ...
    <b-modal id="modal-login" class="modal" hide-footer hide-header>
      ...
      <div class="text-center login__form d-flex flex-column justify">
        <div class="login__form--email d-flex-8px flex-column align-items-start mb-3">
          <div class="label d-flex">
            <i class="fa-solid fa-envelope"></i>
            <p class="">Email</p>
          </div>
          <b-input class="login-form__input" placeholder="Nhập địa Email" v-model="formLogin.email" />
        </div>
        ...
        <div class="d-flex-8px flex-column align-items-start">
          ...
          <b-input type="password" class="login-form__input" placeholder="   Mật khẩu" v-model="formLogin.password" />
        </div>
      </div>
