<template>
	<div class="d-flex flex-wrap justify-content-between">
		<b-form-group class=" carform__detail carform__detail--map" id="address" label="Địa chỉ"
			label-for="address">
			<div class="d-flex flex-row justify-content-between carform__dettail--select mb-3">
				<b-form-select class="carform__detail--mapSelect" id="city" v-model="address.city"
					@input="(e) => $emit('onChangeCity', e)" :options="cities" aria-placeholder="Choose city" required>
				</b-form-select>
				<b-form-select class="carform__detail--mapSelect" id="district" v-model="address.district"
					@input="(e) => $emit('onChangeDistrict', e)" :options="districts" aria-placeholder="Choose district"
					required></b-form-select>

				<b-form-select class="carform__detail--mapSelect" id="ward" v-model="address.ward"
					@input="(e) => $emit('onChangeWard', e)" :options="filterWards" :disabled="!address.district"
					required></b-form-select>
			</div>
		</b-form-group>
		<b-form-input class="carform__detail--input carform__detail--inputMap mb-0" v-model="address.detail"
				@input="(e) => $emit('onChangeAddressDetails', e)" type="text"
				placeholder="Địa chỉ chi tiết: Số nhà,..." :disabled="!(address.ward && address.district)">
			</b-form-input>
	</div>
</template>
